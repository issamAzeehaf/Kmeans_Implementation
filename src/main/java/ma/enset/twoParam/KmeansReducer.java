...
public class KmeansReducer extends Reducer<PointWritable,PointWritable, Text, Text> {
    ...
    @Override
    protected void reduce(PointWritable key, Iterable<PointWritable> values, Context context) throws IOException, InterruptedException {
    ...
    protected void cleanup(Context context) throws IOException, InterruptedException {
        ...
        if( finished )
            ...
            try {
                ...
                FSDataOutputStream fsdo = fs.create( new Path("/input1/centers1.txt") );
